...
UBUNTU_TRANSLATION_DOMAIN="babyapp.etherpulse"
...
aptest.commands = bash $$PWD/BabyApp/tests/autopilot/run
aptest.depends  = sub-BabyApp

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/BabyApp/tests/unit 
unittest.depends  = sub-BabyApp
